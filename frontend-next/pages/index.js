...
import { fetchMovies, fetchWatchHistory } from "../services/api";
...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="w-full max-w-screen-xl px-4 mt-10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <h2 className="text-2xl font-bold mb-4 text-white">🔥 Recommended for You</h2>
        <MovieList mode="recommendations" />
      </motion.div>

      <motion.div className="w-full max-w-screen-xl px-4 mt-10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2 }}>
